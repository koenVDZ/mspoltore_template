...
<doctype>
  ...
  <body class="<?php   echo $responsive . $fixedClass . $sidebarClass?>">
    <header id="header" class="relative spacing-bottom">
      <div class="<?php echo $containerClass ?>">
        <div class="header-logo">
          <img class="header-image" src="https://marielaspoltore.com/images/logos/logo_mscom_fat.svg">
        </div>
        <?php if ($this->countModules('toolbar')) : ?>
        <div class="wrapper-toolbar">
          <w:nav containerClass="<?php echo $containerClass ?>" rowClass="<?php echo $gridMode;?>"
            wrapClass="navbar-fixed-top <?php echo $footerWrapperClass?>" type="toolbar" name="toolbar" />
        </div>
        <?php endif; ?>
        <div class="header-wrapper">
          <div class="header-dummy">
            <div class="header-dummy-image"></div>
          </div>
          <div class="header-item">
            <?php if ($this->countModules('top')) : ?>
            <div id="top" class="header-item-1">
            ...
            <div class="header-item-2 wrapper-logo-menu <?php echo $gridMode; ?> ">
    ...
    <div class="wrapper-footer<?php echo $footerWrapperClass?>">
      <footer id="footer" <?php if ($this->params->get('stickyFooter',1)) : ?> class="sticky z3 relative"
        <?php else : ?>class="z3 relative" <?php endif;?>>
        <div class="<?php echo $containerClass ?>">
